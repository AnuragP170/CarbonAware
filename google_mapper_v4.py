"""
This code generate routes using the API from point to point.
"""
...
route_coordinates = []  # Initialize empty array/grid
for leg in results[0]['legs']:
    ...
    for step in leg['steps']:
        ...
        route_coordinates.extend(polyline_locations)  # Append the coordinates to the array/grid
...
for i, coordinates in enumerate(route_coordinates):
    print(f"Step {i+1} coordinates: {coordinates}")

print("the coordinates from source to destination are - ", route_coordinates)
