...
df_yellow = pd.read_excel('distances.xlsx', sheet_name='Yellow_Line')
df_red = pd.read_excel('distances.xlsx', sheet_name='Red_Line')
df_purple = pd.read_excel('distances.xlsx', sheet_name='Purple_Line')
df_green = pd.read_excel('distances.xlsx', sheet_name='Green_Line')
df_blue = pd.read_excel('distances.xlsx', sheet_name='Blue_Line')
df_brown = pd.read_excel('distances.xlsx', sheet_name='Brown_Line')
...
print(f"\nThe total distance of the shortest path is: {round(shortest_path_length, 2)} km")
